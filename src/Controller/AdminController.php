...
class AdminController extends AbstractController
{
    ...
    #[IsGranted('USER_SHOW', 'user', 'Ce compte ne vous appartient pas !')]
    ...
    #[IsGranted('USER_EDIT', 'user', 'Ce compte ne vous appartient pas !')]
    ...
    #[IsGranted('USER_RESET_PASSWORD', 'user', 'Ce compte ne vous appartient pas !')]
    ...
    #[IsGranted('USER_DELETE', 'user', 'Ce compte ne vous appartient pas !')]
